...
public class ConfigurationReader {
    ...
    static {
        // config dosyasinin yolunu istersek uzun istersek te proje icinde bulundugu icin kisaca yazabiliriz.
        //String pasth = "C:\\Users\\TTR\\IdeaProjects\\mytestNgframework\\configuration.properties";
        String path = "/Users/Abc/IdeaProjects/GMIBANKPROJECT/target/configuration.properties";
        ...
        try {
            ...
            System.out.println("Config file yok:)");
            e.printStackTrace();
        }
    }
