...
import utilities.Driver;
    ...
    public class Us_0405StepDefinitions {
        ...
        public void sign_in_buttona_tiklar() {
            ...
            Assert.assertTrue(signIn04.kullaniciIsmi.isDisplayed());
            Driver.closeDriver();
        }
        ...
        public void cancel_buttona_tiklar() {
            ...
            Driver.waitAndClick(signIn04.SignOut,3);
            Driver.waitAndClick(signIn04.accountMenu,3);
            Driver.waitAndClick(signIn04.SignIn,3);
            Driver.waitAndClick(signIn04.cancelButton,3);
